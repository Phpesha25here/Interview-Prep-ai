...
export const API_PATHS = {
    ...
    AI: {
        GENERATE_QUESTIONS:"/api/ai/generate-questions", // Generate imterview questions and answer using Gemini
    ...
    QUESTION: {
        ...
        UPDATE_NOTE: (id) => `/api/questions/${id}/note`, // Update/Add  a note to aquestion
    },
};