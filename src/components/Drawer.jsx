...
const Drawer =( {isOpen,onClose, title, children}) => {
    return <div 
        className={`fixed top-[64px] right-0 z-40 h-[calc(100dvh-64px)] p-4 overflow-y-auto transition-tranform bg-white w-full md:w-[40vw] shadow-cyan-800/10 border-r border-l-gray-800 ${
