...
const SummaryCard = ({
    colors = { bgcolor: "#fff" }, // ✅ Default colors fallback
    role,
    topicsToFocus,
    experience,
    questions,
    ...
    return (
        <div
            className="bg-white border border-gray-300/40 rounded-xl p-2 overflow-hidden cursor-pointer hover:shadow-xl shadow-gray-100 group relative"
            style={{ background: colors.bgcolor }}
            onClick={onSelect} // ✅ Entire card clickable
        >
            {/* Inner Content */}
            <div
